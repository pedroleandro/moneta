<?= $this->layout("layouts/app_layout", [
        "title" => $title ?? "Cartões de Crédito | " . APP_NAME,
        "active" => "cartoes",
]) ?>
...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-6">
        ...
        <a href="<?= url('/cartoes/novo') ?>" class="btn btn-primary">
            <i class="icon-base bx bx-plus me-1"></i> Novo Cartão
        </a>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            ...
                            <button type="button" class="btn btn-icon btn-outline-danger btn-icon-soft-danger"
                                    title="Excluir"
                                    data-bs-toggle="modal" data-bs-target="#modal-excluir-cartao"
                                    data-action="<?= url('/cartoes/' . $card->getId() . '/excluir') ?>"
                                    data-name="<?= htmlspecialchars($card->getName()) ?>">
