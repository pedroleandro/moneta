<?= $this->layout("layouts/app_layout", [
        "title" => $title ?? "Nova Categoria | " . APP_NAME,
        "active" => "categorias",
]) ?>
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        <div class="card-body">
            <form action="<?= url('/categorias/nova') ?>" method="post">
                <?= csrf_input() ?>
                ...
                <div class="mb-6">
                    ...
                    <div class="d-flex align-items-center gap-3 mb-3">
                        <span class="d-inline-flex align-items-center justify-content-center border rounded"
                            ...
                            <i id="icon-preview" class="icon-base bx <?= old('icon') ?: 'bx-category' ?> icon-md"></i>
                        </span>
                        <input type="text" class="form-control font-monospace" id="icon" name="icon"
                               value="<?= old('icon') ?>" style="max-width: 220px;" placeholder="bx-cart"/>
                    </div>
                    <div class="d-flex flex-wrap gap-2">
