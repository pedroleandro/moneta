        ...
        <div class="col-xxl-8 mb-6 order-0">
            <div class="card">
                <div class="d-flex align-items-start row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            <h5 class="card-title text-primary mb-3">Olá, <?= htmlspecialchars(explode(" ", \App\Core\Auth::user()->name ?? "")[0]) ?>! 👋</h5>
                            <p class="mb-6">
                    ...
                    <div class="col-sm-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-6">
                            <img
                                    src="<?= assets_sneat('/assets/img/illustrations/man-with-laptop.png') ?>"
                                    height="175"
                                    alt="View Badge User"/>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                <div class="avatar flex-shrink-0">
                                    <img
                                            src="<?= assets_sneat('/assets/img/icons/unicons/chart-success.png') ?>"
                                            alt="chart success"
                                            class="rounded"/>
                                </div>
                                <div class="dropdown">
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                <div class="avatar flex-shrink-0">
                                    <img
                                            src="<?= assets_sneat('/assets/img/icons/unicons/wallet-info.png') ?>"
                                            alt="wallet info"
                                            class="rounded"/>
                                </div>
                                <div class="dropdown">
                            ...
                            <div class="text-center mb-6">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="">2021</a>
                                        </li>
                                        <li><a class="dropdown-item" href="">2020</a>
                                        </li>
                                        <li><a class="dropdown-item" href="">2019</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="col-6 mb-6 payments">
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                <div class="avatar flex-shrink-0">
                                    <img src="<?= assets_sneat('/assets/img/icons/unicons/paypal.png') ?>"
                                         alt="paypal"
                                         class="rounded"/>
                                </div>
                                <div class="dropdown">
                ...
                <div class="col-6 mb-6 transactions">
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                <div class="avatar flex-shrink-0">
                                    <img src="<?= assets_sneat('/assets/img/icons/unicons/cc-primary.png') ?>"
                    ...
                    <div class="tab-content p-0">
                        <div class="tab-pane fade show active" id="navs-tabs-line-card-income"
                            ...
                            <div class="d-flex mb-6">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="<?= assets_sneat('/assets/img/icons/unicons/wallet.png') ?>"
                                         alt="User"/>
                                </div>
                                <div>
            ...
            <div class="card h-100">
                ...
                <div class="card-body pt-4">
                    <ul class="p-0 m-0">
                        ...
                        <li class="d-flex align-items-center mb-6">
                            <div class="avatar flex-shrink-0 me-3">
                                <img src="<?= assets_sneat('/assets/img/icons/unicons/chart.png') ?>"
                                     alt="User"
                                     class="rounded"/>
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
