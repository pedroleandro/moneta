                ...
                <div class="card-body">
                  ...
                  <span class="app-brand-logo demo">
                    ...
                    <div class="d-grid gap-3 mb-6">
                        <a href="<?= url('/entrar/facebook') ?>" class="btn btn-social btn-social-facebook">
                            <i class="icon-base bx bxl-facebook-circle me-2"></i> Continuar com Facebook
                        </a>

                        <a href="<?= url('/entrar/google') ?>" class="btn btn-social btn-social-google">
                            <svg width="18" height="18" viewBox="0 0 48 48" class="me-2" xmlns="http://www.w3.org/2000/svg">
